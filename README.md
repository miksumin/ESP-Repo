...
Получить отчет об ID, поддерживаемых вашим котлом, можно включив в коде режим DEBUG, в котором при работе алгоритма список таких ID будет выведен в Serial Terminal,
или с помощью режима "Test Boiler IDs" в бесплатной версии прошики.