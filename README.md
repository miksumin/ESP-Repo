...
ESP-Opentherm (https://github.com/miksumin/ESP-Repo/blob/main/ESP-OT.md) это проект контроллера на основе ESP8266/ESP32 для управления работой котла. Контроллер использует гибкий или "обучаемый" алгоритм взаимодействия с котлом.
