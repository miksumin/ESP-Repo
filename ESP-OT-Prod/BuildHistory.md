2.1.5(20260130)
Исправлены найденные ошибки и выполнены доработки алгоритмов модуля Opentherm. Ручная установка CHtemp и DHWtemp сделана с точностью 1 град + добавлены пределы установки для HA. Cделано деление на 10 для параметра DHW Flow rate для котлов Виссман и Бакси. Сделано деление на 10 для параметра Fan Speed.
